...
const Session3Prompt = () => {
  // Fecha de desbloqueo: 13 de febrero 2026 a las 7pm hora México (CST/CDT)
  const unlockDate = new Date('2026-02-13T19:00:00-06:00');
        ...
        {!isUnlocked ? (
          ...
          <div>
            ...
            <p className="text-muted-foreground text-lg mb-8">
              Aquí encontrarás el prompt completo para desarrollar tu Regenmon en la Sesión 3.
            </p>
