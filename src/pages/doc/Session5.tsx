    ...
    <DocLayout>
      <DocContent>
        ...
        <p className="text-muted-foreground text-lg mb-8">
          {t('doc.quickStartPage.sessions.session5.description')}
        </p>
        ...
        <div className="space-y-3 mb-12">
          {(t('doc.quickStartPage.sessions.session5.whatYouBuild', { returnObjects: true }) as string[]).map((item, i) => (
        ...
        <div className="space-y-12 mt-16">
          ...
          <div>
            ...
            <PromptBlock
              ...
              title="Prompt para Sesión 5: Social"
            />
          </div>
