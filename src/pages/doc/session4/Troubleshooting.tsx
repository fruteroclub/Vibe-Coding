      ...
      <DocContent>
        <div className="flex items-center gap-3 mb-4">
          ...
          <h1 className="gradient-text text-4xl font-bold">
            {t('doc.session4Troubleshooting.title')}
          </h1>
        </div>
        <p className="text-muted-foreground text-lg mb-8">
          {t('doc.session4Troubleshooting.subtitle')}
        </p>
        ...
        <div className="glass-card p-6 mb-6 border-l-4 border-red-500">
          <div className="flex items-start gap-4 mb-4">
            ...
            <div>
              <h2 className="text-2xl font-bold text-orange-400 mb-2">
                {t('doc.session4Troubleshooting.error1.title')}
              </h2>
              <p className="text-muted-foreground mb-4">
                {t('doc.session4Troubleshooting.error1.description')}
              </p>
            </div>
          </div>
          ...
          <div className="bg-orange-400/10 border border-orange-400/30 rounded-lg p-4 mb-4">
            ...
            <ol className="space-y-2 text-foreground">
              {t('doc.session4Troubleshooting.error1.solutions', { returnObjects: true }).map((solution: string, index: number) => (
          ...
          <div className="bg-blue-400/10 border border-blue-400/30 rounded-lg p-4">
            ...
            <p className="text-foreground text-sm">
              {t('doc.session4Troubleshooting.error1.why')}
            </p>
          </div>
        </div>
        ...
        <div className="glass-card p-6 mb-6 border-l-4 border-yellow-500">
          <div className="flex items-start gap-4 mb-4">
            ...
            <div>
              <h2 className="text-2xl font-bold text-orange-400 mb-2">
                {t('doc.session4Troubleshooting.error2.title')}
              </h2>
              <p className="text-muted-foreground mb-4">
                {t('doc.session4Troubleshooting.error2.description')}
              </p>
            </div>
          </div>
          ...
          <div className="bg-orange-400/10 border border-orange-400/30 rounded-lg p-4 mb-4">
            <h3 className="font-bold text-orange-400 mb-2">✅ Soluciones:</h3>
            <ol className="space-y-2 text-foreground">
              {t('doc.session4Troubleshooting.error2.solutions', { returnObjects: true }).map((solution: string, index: number) => (
                <li key={index} dangerouslySetInnerHTML={{ __html: solution }} />
              ))}
            </ol>
          </div>
          ...
          <div className="bg-blue-400/10 border border-blue-400/30 rounded-lg p-4">
            <h3 className="font-bold text-blue-400 mb-2">💡 Por qué pasa:</h3>
            <p className="text-foreground text-sm">
              {t('doc.session4Troubleshooting.error2.why')}
            </p>
          </div>
        </div>
        ...
        <div className="glass-card p-6 mb-6 border-l-4 border-purple-500">
          <div className="flex items-start gap-4 mb-4">
            ...
            <div>
              <h2 className="text-2xl font-bold text-orange-400 mb-2">
                {t('doc.session4Troubleshooting.error3.title')}
              </h2>
              <p className="text-muted-foreground mb-4">
                {t('doc.session4Troubleshooting.error3.description')}
              </p>
            </div>
          </div>
          ...
          <div className="bg-orange-400/10 border border-orange-400/30 rounded-lg p-4 mb-4">
            <h3 className="font-bold text-orange-400 mb-2">✅ Soluciones:</h3>
            <ol className="space-y-2 text-foreground">
              {t('doc.session4Troubleshooting.error3.solutions', { returnObjects: true }).map((solution: string, index: number) => (
                <li key={index} dangerouslySetInnerHTML={{ __html: solution }} />
              ))}
            </ol>
          </div>
          ...
          <div className="bg-blue-400/10 border border-blue-400/30 rounded-lg p-4">
            <h3 className="font-bold text-blue-400 mb-2">💡 Por qué pasa:</h3>
            <p className="text-foreground text-sm">
              {t('doc.session4Troubleshooting.error3.why')}
            </p>
          </div>
        </div>
        ...
        <div className="glass-card p-6 bg-gradient-to-r from-orange-400/10 to-pink-400/10 border-2 border-orange-400/30">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-2xl font-bold text-orange-400">
              {t('doc.session4Troubleshooting.needHelp.title')}
            </h2>
          </div>
          <p className="text-foreground mb-4">
            {t('doc.session4Troubleshooting.needHelp.intro')}
          </p>
          <ol className="space-y-3 text-foreground mb-6">
            {t('doc.session4Troubleshooting.needHelp.steps', { returnObjects: true }).map((step: string, index: number) => (
