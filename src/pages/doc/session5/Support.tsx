...
const Session5Support = () => {
  ...
  const materialIcons: { [key: string]: React.ReactNode } = {
    ...
    1: <FileText size={24} className="text-blue-400" />,
    2: <Code size={24} className="text-green-400" />,
    3: <BookOpen size={24} className="text-orange-400" />,
  };
    ...
    <DocLayout>
      <DocContent>
        ...
        <div className="space-y-6">
          {(t('doc.quickStartPage.sessions.session5.supportMaterial', { returnObjects: true }) as string[]).map((material, i) => (
            <div
              key={i}
        ...
        <div className="mt-12 p-6 border-l-4 border-orange-400 bg-orange-500/5 rounded-r-lg">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Revisa estos materiales ANTES de empezar a codificar. Te ayudarán a entender mejor los conceptos y a escribir mejores prompts para v0.
          </p>
        </div>
        ...
        <div className="mt-16 flex items-center justify-between border-t border-border/50 pt-8">
          ...
          >
            <div>
              <div className="text-xs text-muted-foreground">Volver al inicio</div>
