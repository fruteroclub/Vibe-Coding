...
**Frutero Club**: https://x.com/fruteroclub
**Registro al Bootcamp**: https://tally.so/r/gDqk1M
...
### Requisitos
- Tener Bun instalado → [instalar Bun](https://bun.sh)
...
### Contacto
- **Twitter/X**: [@fruteroclub](https://x.com/fruteroclub)
...
**VibeCoding Bootcamp** - Frutero Club 2024
Landing page construida con React + Vite + Tailwind
